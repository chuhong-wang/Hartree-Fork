...
class Molecule:
    ...
    def obtain_nocc(self):
        ...
        print("atom charges", self.atom_charges, "charge: ",  self.charge)
    ...
    def eng_mp2_corr(self):
        ...
        print(nocc, e)
        swapped = 2 * eri_iajb - eri_iajb.swapaxes(-1, -3)
        
        D_iajb = e[:nocc, None, None, None] - e[None, nocc:, None, None] + e[None, None, :nocc, None] - e[None, None, None, nocc:]
        print("eri_iajb: ", eri_iajb.shape, "D_iajb: ", D_iajb.shape, "operand: ", swapped.shape )
        print(eri_iajb[0,0,0,0],D_iajb[0,0,0,0])
        print(np.divide(eri_iajb, D_iajb)==eri_iajb/D_iajb)
